                                    ...
                                    <div class="col-xl-6 ">
                                          ...
                                          <div class="form-group">
                                             ...
                                             <select name="applicationType" id="applicationType" class="form-control" style="color:black; height: 40px;">
                                                <option value="">FIND PAN NUMBER - By Details</option>
                                             </select>
                                       ...
                                       <div class="col-xl-6  ">
                                          ...
                                          <div class="form-group">
                                             ...
                                             <input type="text" class="form-control" id="charges" name="charges" placeholder="" value="Processing Fee Rs 107" readonly>
                                          </div>
                                       </div>
