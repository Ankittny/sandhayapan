@include('web.header')
<script src="{{ asset('public/web') }}/assets/js/cities.js"></script>
<style>
...
<section class="sec-cen">
              ...
              <div class="col-xl-6 mx-auto ">
                        ...
                        <p class="text-muted">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s,</p>
                           ...
                           @if(\Session::has('success'))
                            <div class="alert alert-info coolest">
                                {!! \Session::get('success') !!} </ul>
                            </div>
                            @endif
		<section class="services pan-no form-ky">
            <div class="row ">
        ...
        <div class="">
          ...
          <p class="text-secondary">Your simple personal information required for identification.</p>
                  ...
                  <div class="card-body">
                    ...
                    <form onchange="onFormUpdate()" action="{{ url('kycStore') }}" method="Post" class="forms-sample pan-services">
                    @csrf
                        <div class="row ">
                      <div class="col-sm-12">
          ...
          <p class="text-secondary">Please type carefully and fill out the form with your personal details. Your can’t edit these details .</p>
              ...
              <div class="col-xl-6  ">
                      <div class="form-group">
                        <label for="kycName">Full Name<span class="start"> *</span></label>
                        <input type="text" onkeydown="return /[a-z, ]/i.test(event.key)" class="form-control" id="kycName" value="{{ Session::get('name') }}" placeholder="" name="name" required>
                      </div>  </div>
                       <div class="col-xl-6  ">
                      <div class="form-group">
                        <label for="kycEmail">Email Address<span class="start"> *</span></label>
                        <input name="email" type="email" class="form-control" value="{{ Session::get('email') }}" id="kycEmail" placeholder="" readonly>
                      </div>
                      </div>
                       <div class="col-xl-6  ">
                      <div class="form-group">
                        <label for="kycMobile">Phone Number<span class="start"> *</span></label>
                        <input name="phoneNo" type="number" onKeyPress="if(this.value.length==10) return false;" class="form-control" id="kycMobile" value="{{ Session::get('mobile') }}" placeholder="" readonly>
                      </div>
                      </div>
                       <div class="col-xl-6  ">
                      <div class="form-group">
                        <label for="kycDob">Date of Birth<span class="start"> *</span></label>
                        <input name="dob" type="date" class="form-control" id="kycDob" placeholder="">
                      </div>
                      </div>
                        <div class="col-xl-6  ">
                      <div class="form-group">
                        <label for="kycAadhaar">Aadhaar Number<span class="start">*</span></label>
                        <input name="aadhaar" type="number" onKeyPress="if(this.value.length==12) return false;" class="form-control" id="kycAadhaar" placeholder="">
                      </div>
                      </div>
                        <div class="col-xl-6  ">
                      <div class="form-group">
                        <label for="kycPan">PAN Number<span class="start"> *</span></label>
                        <input name="pan" type="text" maxlength="10" style="text-transform:uppercase;" class="form-control" id="kycPan" placeholder="">
                      </div>
                      </div></div>
        ...
        <div class="mr-3">
          <div class="p-4 rounded-circle text-white font-weight-bold d-flex align-items-center justify-content-center" style="height: 40px; width: 40px; background-color: #9B5DE5">
          <div class="number" id="fooler" style="display:block;" >
            02
          </div>
...
Your Address</h5>
          <p class="text-secondary">Your simple personal information required for identification</p>
                    ...
                    <div class="col-xl-4">
                      <div class="form-group">
                        <label for="kycCountryName">Country Name<span class="start"> *</span></label>
                        <select name="country" id="kycCountryName" class="form-control" readonly>                            
                      ...
                      <div class="col-xl-4  ">
                      <div class="form-group">
                        <label for="kycState">State/Union Territory<span class="start"> *</span></label>
                        <select onchange="print_city('state', this.selectedIndex);" id="sts" name ="country" class="form-control" required></select>
                      </div>
                      </div>

                      <div class="col-xl-4">
                      <div class="form-group">
                        <label for="kycTown">Town/City/District <span class="start"> *</span></label>
                      ...
                      <div class="col-xl-4  ">
                      <div class="form-group">
                        <label for="kycPin">Pin Code<span class="start"> *</span></label>
                        <input type="number" onKeyPress="if(this.value.length==7) return false;" class="form-control" name="pin" id="kycPin" placeholder="">
                      </div>
                      </div>

                      <div class="col-xl-4  ">
                      <div class="form-group">
                        <label for="kycCountryCode">Country code (ISD code)
                            <span class="start"> *</span></label>
                            <select name="countryCode" id="kycCountryCode" class="form-control" readonly>
                       ...
                       <div class="col-xl-4  ">
                      <div class="form-group">
                        <label for="kycFlat">Flat/Room/Door/Block No. <span class="start"> *</span></label>
                        <input name="flat" type="text" maxlength="25" class="form-control addrss" id="kycFlat" placeholder="">
                      </div>
                      </div>
                       <div class="col-xl-4  ">
                      <div class="form-group">
                        <label for="kycBuilding">Name of Premises/Building/Village<span class="start"> *</span></label>
                        <input name="building" type="text" maxlength="25" class="form-control" id="kycBuilding" placeholder="">
                      </div>
                      </div>
                      <div class="col-xl-4  ">
                      <div class="form-group">
                        <label for="kycRoad">Road/Street/lane/Post Office<span class="start"> *</span></label>
                        <input name="street" type="text" maxlength="25" class="form-control" id="kycRoad" placeholder="">
                      </div>
                      </div>
                        <div class="col-xl-4  ">
                      <div class="form-group">
                        <label for="kycArea">
                            Area/Locality/Taluka/Sub-Division <span class="start"> *</span></label>
                        <input name="area" type="text" maxlength="25" class="form-control" id="kycArea" placeholder="">
                      </div>
                      </div>
        ...
        <div class="mr-3">
          <div class="p-4 rounded-circle text-white font-weight-bold d-flex align-items-center justify-content-center" style="height: 40px; width: 40px; background-color: #9B5DE5">
          <div class="number" id="dooler" style="display:block;" >
            03
          </div>
  ...
  <label for="vehicle1" class="label-1">Chosen credential must not be expired.</label><br>
   <input name="chkBox_1" type="checkbox" checked value="1" readonly />
  <label for="vehicle2"class="label-1">Document should be good condition and clearly visible.</label><br>
   <input name="chkBox_1" type="checkbox" checked value="1" readonly />
  <label for="vehicle3" class="label-1">Make sure that there is no light glare on the card.</label><br><br>
  </div>
   </div>
  <div class="row ">
     <div class="col-xl-12 ">
  ...
  <div class="form-group"><div class="custom-control custom-control-xs custom-checkbox"><input type="checkbox" id="kycInfo" class="custom-control-input" value="on"> <label for="kycInfo" class="custom-control-label">All The Personal Information I
                                        Have Entered Is Correct.</div></div>
                                        </div>
  </div>
