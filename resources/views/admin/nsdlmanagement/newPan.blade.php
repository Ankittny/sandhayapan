...
<style>
   ...
   button.btn.btn-primary.ack-bnt {
    width: 100%;
}
.para-sec button {
...
<div class="content-body">
   ...
   <div class="container-fluid">
    ...
    <option value="volvo">Process in Documents</option>
            ...
            <div class="card-body">
               <div class="table-responsive">
                     ...
                     <thead>
                        ...
                        <tr role="row">
                           ...
                           <th class="sorting action-sec" tabindex="0" aria-controls="example4" rowspan="1" colspan="1" aria-label="Action	: activate to sort column ascending" style="width: 108.312px;">Amount	</th>
                                                      <th class="sorting action-sec sort-c" tabindex="0" aria-controls="example4" rowspan="1" colspan="1" aria-label="Action	: activate to sort column ascending" style="width: 108.312px;     min-width: 230px !important;">	Paam</th>
                  ...
                  <tr role="row" class="odd">
                           ...
                           <td class="sorting_1">
                              <div class="para-sec">
                                  <button type="submit" class="btn btn-primary ack-bnt">Indian Citizen</button>
                              ...
                              <button type="submit" class="btn btn-primary">View File</button>
                                 <button type="submit" class="btn btn-primary">Download Pdf</button>
                                          <button type="submit" class="btn btn-primary ack-bnt" >Acknowledgment Invoice</button>
