         ...
         <div class="col-xl-12 col-lg-12">
            <div class="card">
               ...
               <div class="card-body">
                ...
                @endif
                     <form action="{{ url('admin/editvideou') }}" method="Post" enctype="multipart/form-data">
                        ...
                        <div class="row">
                           <div class="col-xl-6 col-lg-6">
                              ...
                              <div class="input-group mb-3 input-warning-o">
                                 ...
                                 <input type="text" class="form-control" name="title" placeholder="Enter Your Title" value="{{ $video->title ?? ''  }}">
                                 @if ($errors->has('title'))
                         ...
                         <input type="hidden" class="form-control" name="oldimage" value="{{$video->image}}">
                                 @if ($errors->has('image'))
                         ...
                         @endif
                           ...
                           <div class="col-xl-12 col-lg-12">
                              ...
                              <div class="input-group mb-3 input-success-o">
                                 ...
                                 <input type="text" class="form-control" name="link" placeholder="Enter Your Youtube Link" value="{{ $video->link ?? ''  }}">
                                 @if ($errors->has('link'))
