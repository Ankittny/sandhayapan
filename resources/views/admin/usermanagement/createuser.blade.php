                                ...
                                <div class="basic-form">
                                    <form action="#">
										...
										<div class="input-group mb-3 input-success-o">
											...
											<span class="input-group-text"><i class="mdi mdi-lock-outline text-primary"></i></span>
													
                                      <select class="select form-select form-select-lg mb-3" aria-label="form-select-lg">   
    <option style="font-weight: bold;text-transform: uppercase;"value="tetle" selected="">Retailer</option>
        <option style="font-weight: bold;text-transform: uppercase;"value="tetle" selected="">ABCD</option>
            <option style="font-weight: bold;text-transform: uppercase;"value="tetle" selected="">Retailer</option>
                <option style="font-weight: bold;text-transform: uppercase;"value="tetle" selected="">Retailer</option>
  </select>
                    ...
                    <i class=" mdi mdi-chevron-down"></i>                    </div>
                                                  ...
                                                  <div class="col-xl-6 col-lg-6">
                                                      	<label>Email</label>
										<div class="input-group mb-3 input-success-o">
											<span class="input-group-text">      <i class="mdi mdi-email-outline text-primary"></i></span>
