                    ...
                    <div class="col-md-15 col-sm-3">
                                ...
                                <div class="basic-list-group">
                                    <ul class="list-group">
                                        <li class="list-group-item">
                                                                  ...
                                                                  <input type="text" placeholder=" Find PAN to Aadhaar No">
                                            </li>
                                     <li class="list-group-item">
                                             ...
                                             <li class="list-group-item btn-services">
                                            
                                                                <button id="addmore">Add Services</button>
                                            </li>
                       ...
                       <div class="col-md-15 col-sm-3">
                            ...
                            <div class="card-body">
                                <div class="basic-list-group list-group">
                                     <h1>
                                           ...
                                           <input type="text" placeholder="  Free Retailer">
                                   ...
                                   <span class="rupe">
                                     ...
                                     <p>
                                           <input type="text" placeholder="Lifetime Validity">
                                         </p>
                                     <div class="text-center mt-4">
                                            <button type="submit" class=" btn-block">Buy now</button>
                                        </div>
                                    <ul class="list-group list-user">
                                        <li class="list-group-item bootom-spacing"><div class="col-auto my-1">
                                            ...
                                            <input type="text" class="form-control text-send btn-senmd" placeholder="99">
                                        </div>
                                              </li>
                            <li class="list-group-item bootom-spacing"><div class="col-auto my-1">
                            ...
                            <div class="card-body">
                                <div class="basic-list-group  list-group plan-sec">
                                      <h1>
                                           ...
                                           <input type="text" placeholder="  Retailer Plus">
                        ...
                        <div class="card card-1 ss">
                            ...
                            <div class="card-body">
                                <div class="basic-list-group  list-group plan-sec2">
                                           <h1>
                        ...
                        <div class="card card-1 ss card-border">
                            <!--<div class="card-header padd-0" style="background:0;">-->
                            <!--    <h4 class="card-title title-text most-p" style=" visibility: hidden;">MOST POPULAR!</h4>-->
                            ...
                            <div class="card-body">
                                <div class="basic-list-group list-group plan-sec3">
                                            <h1>
                                         
                                         
                                           <input type="text" placeholder="  Super Distributor">
