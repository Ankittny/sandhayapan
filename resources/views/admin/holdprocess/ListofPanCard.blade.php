...
button.btn.btn-primary.btn-dele {
    background: #e74a3b !important;
    color: white;
}
button.btn.btn-primary.same-bnt {
    width: 100%;
}
.box-secs {
...
.input-group.group-sec.sec-s input {
    width: 100% !important;
}
.flex-parts {
    display: flex;
...
<div class="content-body">
  ...
  <ul class="dropdown-menu">
    ...
    <li><a class="dropdown-item" href="#">Something else here</a></li>
             ...
             <div class="col-md-8">
                 <div class="row center">
                        ...
                        <div class="col-md-6 flex-parts">
                        <span>Search:</span>   
                 <div class="input-group group-sec sec-s">
    ...
    <option value="volvo">ALL DATA</option>
    <option value="saab">PROCESS</option>
    <option value="opel">SUCCESS</option>
    <option value="audi">HOLD DOCUMENTS</option>
        <option value="audi">HOLD FORM</option>
              <option value="audi">HOLD PROCESS IN DOCUMENTS</option>
                  <option value="audi">HOLD PROCESS IN FORM</option>
            ...
            <div class="card-body">
                        ...
                        <tr role="row">
                           ...
                           <th class="sorting action-sec" tabindex="0" aria-controls="example4" rowspan="1" colspan="1" aria-label="Action	: activate to sort column ascending" style="width: 108.312px;">Amount	</th>
                                        ...
                                        <th class="sorting action-sec" tabindex="0" aria-controls="example4" rowspan="1" colspan="1" aria-label="Action	: activate to sort column ascending" style="width: 108.312px;">BALANCE	</th>  
                                              ...
                                              <th class="sorting action-sec sort-c" tabindex="0" aria-controls="example4" rowspan="1" colspan="1" aria-label="Action	: activate to sort column ascending" style="width: 108.312px;   ;">	STATUS</th>
                       
                       
                         <th class="sorting action-sec sort-d" tabindex="0" aria-controls="example4" rowspan="1" colspan="1" aria-label="Action	: activate to sort column ascending" style="width: 108.312px;    min-width: 150px !important  ">Action	</th>
                  ...
                  <tr role="row" class="odd">
                   ...
                   <td class="sorting_1">
                              ...
                              <div class="para-sec">
                                 ...
                                 <p>KEITHELLAKPAM BINARANI DEVI KEITHELLAKPAM BINARANI DEVI </p>
                            ...
                            <button type="submit" class="btn btn-primary btn-c">Track Status</button>
                              ...
                              <div class="para-sec">
                                ...
                                <div class="para-sec">
                                 ...
                                 <p class="hold-process bottom-se"> Process </p>
              ...
              <div class="para-sec sec-pros">
                              
                              <button type="submit" class="btn btn-primary btn-c view">Update</button>
                          
                                 <button type="submit" class="btn btn-primary btn-dele">Delete</button>
                            
                              
                                      <button type="submit" class="btn btn-primary same-bnt">Download Pdf</button>
                                       <button type="submit" class="btn btn-primary same-bnt">View File</button>
