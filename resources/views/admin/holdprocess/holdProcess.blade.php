            ...
            <div class="card-header">
               ...
               <div class="tag-selction">
                  <select name="cars" id="cars">
                     <option value="volvo">Process Acknowledgement No.</option>
            ...
            <div class="card-body">
               <div class="table-responsive">
                  <table id="example4" class="display dataTable no-footer"  role="grid" aria-describedby="example4_info">
                     ...
                     <tbody>
                        @if($holdProcess->count()> 0)
                        @foreach($holdProcess as $item)
                        <tr role="row" class="odd">
                           <td class="sorting_1 ">
                              ...
                              <div class="para-sec">
                                 <p> {{$item->applicant_first_name ?? ''}} {{$item->applicant_middle_name ?? '' }} {{$item->applicant_last_name ?? '' }} </p>
                              </div>
                              <div class="para-sec">
                                 <p>{{$item->dob_incorporationation ?? '' }}</p>
                              </div>
                              <div class="para-sec">
                                 <p>472972329</p>
                              </div>
