...
<div class="content-body">
   ...
   <div class="container-fluid">
    ...
    <option value="volvo"> Hold Process in Documents</option>
    <option value="volvo"> Hold Process in Form</option>
  </select>
            </div>
                            ...
                            <button type="submit" class="btn btn-primary btn-c">Track Status</button>
                              ...
                              <div class="para-sec">
                                ...
                                <div class="para-sec">
                                 ...
                                 <p class="hold-process bottom-se">Hold Process </p>
                                
                              </div> 
                              <div class="para-sec">
                              
                              <button type="submit" class="btn btn-primary btn-c">DownLoad pdf</button>
                          
                                 <button type="submit" class="btn btn-primary">Docs</button>
