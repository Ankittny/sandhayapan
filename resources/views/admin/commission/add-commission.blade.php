         ...
         <div class="col-xl-12 col-lg-12">
            <div class="card">
               <div class="card-header">
                  <h4 class="card-title">Create Commission</h4>
               </div>
               <div class="card-body">
                ...
                @endif
                     <form action="{{ url('admin/addcommissions') }}" method="Post" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                           <div class="col-xl-6 col-lg-6">
                              ...
                              <div class="input-group mb-3 input-warning-o">
                                 ...
                                 <input type="text" class="form-control" name="profile" placeholder="Enter Your profile">
                         ...
                         @endif
                           ...
                           <div class="col-xl-6 col-lg-6">
                              ...
                              <div class="input-group mb-3 input-success-o">
                                 ...
                                 <input type="text" class="form-control" name="vat_no" placeholder="Enter Your Youtube vat_no">
