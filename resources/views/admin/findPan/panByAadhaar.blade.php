        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Pending Lost Pan By Aaadhar No</h4>
                </div>
                <div class="card-body">
                    <div class="table-responsive">
                        <table id="example4" class="display dataTable no-footer" role="grid" aria-describedby="example4_info">
                            ...
                            <tbody>
                                @foreach($aadhaar as $item)
                                <tr role="row" class="odd">
                                    <td class="sorting_1">
                                        <div class="para-sec">
                                            <p>Full Name : {{$item->appName}}</p>
                                            <p>Aaadhar No : {{$item->aadhaarNo}}</p>
                                    </td>
                                    ...
                                    <td class="sorting_1  button-group">
                                        <div class="input-group mb-3 input-success-o">
                                            ...
                                            <form action="{{ url("admin/updatedata") }}" method="Post">
                                                ...
                                                <select class="select form-select form-select-lg mb-3" aria-label="form-select-lg" name="status" value="{{ $item->status ?? '' }}">
                                                    <option style="font-weight: bold;" value="">Select</option>
                                                    <option style="font-weight: bold;" value="Success" <?php if($item->status == 'Success') { ?> selected="selected"<?php } ?>>Success</option>
                                                    <option style="font-weight: bold;" value="Reject" <?php if($item->status == 'Reject') { ?> selected="selected"<?php } ?>>Reject</option>
                                                </select>
                                                <div class="mb-3">
                                                    <input type="text" class="form-control" name="value" value="{{ $item->panno ?? '' }}">
